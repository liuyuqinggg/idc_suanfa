...
int main(int argc, char  *argv[])
{
    ...
    if (argc!=5)
    {
        ...
        printf("Example:/home/lyq/project/tools1/bin/procctl 120 /home/lyq/project/myidc/bin/obtcodetodb /home/lyq/project/myidc/ini/stcode.ini \"127.0.0.1,root,mysql,mysql,3306\" utf8 /home/lyq/project/log/obtcodetodb.log\n\n");
...
bool LoadSTCode(const char *inifile)
{
  ...
  while (true)
  {
    ...
    if (CmdStr.CmdCount()!=6) continue;     // 扔掉无效的行 第一行因为没有逗号，所以没有被拆分为6个。
