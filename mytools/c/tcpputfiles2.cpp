/*
 * 程序名：tcpputfiles.cpp，此程序用于演示网银APP软件的客户端，增加了心跳报文。
 * 作者：吴从周。
*/
#include "_public.h"
...
struct st_arg{
  ...
  char ip[31];
  int port;
  int ptype; //文件上传后的处理方式 1-删除文件 2-移动到备份目录
  char clientpath[301];
  char clientpathbak[301];
  bool andchild; //是否上传各级子目录中的文件
  char matchname[301];
  char srvpath[301];
...
{
  printf("\n");
  printf("Using:/home/lyq/project/mytools/bin/tcpputfiles logfilename xmlbuffer\n\n");

  printf("Sample:/home/lyq/project/mytools/bin/procctl 20 /home/lyq/project/mytools/bin/tcpputfiles /home/lyq/project/log/tcpputfiles_surfdata.log \"<ip>127.0.0.1</ip><port>5005</port><ptype>1</ptype><clientpath>/home/lyq/project/surfdata1</clientpath><clientpathbak>/home/lyq/project/surfdata1bak</clientpathbak><andchild>true</andchild><matchname>*.XML,*.CSV</matchname><srvpath>/home/lyq/project/surfdata2</srvpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpputfiles_surfdata</pname>\"\n");
  printf("       /home/lyq/project/mytools/bin/procctl 20 /home/lyq/project/mytools/bin/tcpputfiles /home/lyq/project/log/tcpputfiles_surfdata.log \"<ip>127.0.0.1</ip><port>5005</port><ptype>2</ptype><clientpath>/home/lyq/project/surfdata1</clientpath><clientpathbak>/home/lyq/project/surfdata1bak</clientpathbak><andchild>true</andchild><matchname>*.XML,*.CSV</matchname><srvpath>/home/lyq/project/surfdata2</srvpath><timetvl>10</timetvl><timeout>50</timeout><pname>tcpputfiles_surfdata</pname>\"\n\n\n");
